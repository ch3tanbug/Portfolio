      ...
      {page === "index" ? (
        ...
        <div className="hidden fixed left-10 bottom-0 md:flex flex-col w-6 h-56 items-center justify-between">
          <div className="-rotate-90 text-lg tracking-widest">
            <a
              href={`mailto:ch3tanbug@duck.com`}
...
const socialLinks = [
  ...
  },
  {
    ...
    svg: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="28" height="28" className="dark:fill-bglight hover:fill-marrsgreen dark:hover:fill-carrigreen ml-2 mt-[1px]">
  ...
  },
  {
    ...
    link: "https://www.instagram.com/chetans_gamezz/",
    svg: (
      <svg
...
const navLinks = [
  ...
  {
    url: "https://blog.ch3tanbug.sec",
    text: "Blog",
  },
  {
    url: "https://ch3tanbug-aswm93rw5-ch3tanbugs-projects.vercel.app/",
    text: "Terminal",
  },
  {
    url: "#contact",
