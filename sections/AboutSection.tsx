        ...
        <RoughNotationGroup>
          ...
          <div className="md:grid grid-rows-5 lg:grid-rows-6 grid-cols-5">
            ...
            <p className="col-start-1 col-end-3 row-start-4 row-end-6 lg:row-start-1 lg:row-end-2 lg:col-start-3 lg:col-end-6 lg:ml-8 lg:mt-auto about-intro">
              With 2+ years of comprehensive experience in security testing on various 
              platforms, I have honed my skills in web, network, mobile and cloud 
              security testing. In addition to my hands-on experience on 
              tryhackme, hackthebox and in Bug-Bounties, my self learner skills has also 
...
const educationInfo = [
  {
    ...
    subTitle: "Guru Nanak Dev Engineering College | 2022 ~ 2025",
    list: [
      "Studied computer applications, software development, Networking ",
      "Graduated with 9.5+ CGPA",
    ],
  },
  {
    id: 2,
    title: "Certified Network Security Practitioner (CNSP)",
    subTitle: "SecOps Group | 2024 ",
    list: [
      "Gained comprehensive knowledge in network security fundamentals, including TCP/IP protocols, Active Directory, cryptography, vulnerability assessment, and security tools."
          ],
  },
  {
    id: 3,
    title: "OCI Certified Security Professional",
    subTitle: "Oracle Cloud Infrastructure | 2023 ~ 2025",
    list: ["Skilled in OCI security services for cloud environments, including IAM, data protection, network security, application security, and operational monitoring. Familiar with compliance frameworks to ensure regulatory adherence."],
  },
  {
    id: 4,
    title: "Certified Cyber Security Analyst (C3SA)",
    subTitle: "CyberWarFare Labs | 2023",
    list: ["Extensive understanding of web fundamentals, including common mis-configurations and hands-on experience with OWASP Top 10 vulnerabilities. Proficient in automation using tools and real-world case studies of critical bugs. "],
  },
  {
    id: 5,
    title: "Certified AppSec Practitioner (CAP)",
    subTitle: "SecOps Group | 2023",
    list: ["Made me proficient in SQL Injection, CSRF, encryption methods, OWASP Top 10 vulnerabilities, TLS security, and secure cookie management. Skilled in mitigating XSS, SSRF, IDOR, and ensuring secure authentication and authorization practices."],
  },
];
