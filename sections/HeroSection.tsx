    ...
    >
      ...
      <div className="lg:basis-2/3 z-10 relative">
        ...
        <div className="mt-2 my-4 md:mb-8">
          <p className="mb-1">
            I am a White-Hat Hacker with a passion for securing
            organisational assets.
          </p>
          <p>
            <br />
            A skilled security engineer with expertise in identifying security issues in cloud environments, web applications, iOS, and Android apps. Proficient in implementing robust security infrastructure within organizations and possessing a strong understanding of SIEM (Security Information and Event Management) and SOAR (Security Orchestration, Automation, and Response) tools. Background includes a proactive approach to threat assessments, security implementation, and vulnerability identification. Maintains a commitment to continuous learning, staying current with the latest security trends and technologies.
          </p>
        </div>
        <LinkButton href={`mailto:chetanbug@duck.com`}>
          Contact me!
        </LinkButton>
      </div>
      <a
